...
<div id="openfloatmainlsbj" style="width: 20px;height: 20px;position: fixed;z-index: 700; right: 0px; top: 70px; text-align: center;line-height: 20px;background: #dd9822;color: white;border: 1px solid white">
    O
</div>
